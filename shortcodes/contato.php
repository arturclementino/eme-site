        ...
        <section class="eme-hero-sub">
            <div class="eme-container">
                ...
                <p class="eme-hero-subtitle">
                    Estamos à disposição para agendar sua visita, tirar dúvidas e realizar sua matrícula na EME.
                </p>
            </div>
        </section>
            ...
            <div class="eme-container">
                <div class="eme-grid-contato">
                    ...
                    <div class="eme-contato-form-box">
                        ...
                        <p style="margin-bottom: 20px; color: #666; font-size: 14px;">Preencha o formulário abaixo e nossa equipe responderá rapidamente.</p>

                        <form action="#" method="post" class="eme-form" onsubmit="event.preventDefault(); alert('Obrigado pelo contato! Sua mensagem foi recebida pela equipe da EME.');">
                            ...
                            <div class="eme-form-row">
                                <div class="eme-form-group">
                                    <label for="eme-email">E-mail</label>
                            ...
                            <div class="eme-form-row">
                                <div class="eme-form-group">
                                    ...
                                    <select id="eme-assunto" name="assunto" required>
                                        ...
                                        <option value="eventos">Eventos & Recitais</option>
                                        <option value="doacoes">Projeto Amigos da EME (Doações)</option>
                            ...
                            <div class="eme-form-group">
                                ...
                                <textarea id="eme-mensagem" name="mensagem" rows="4" placeholder="Escreva sua mensagem ou dúvida..." required></textarea>
                            </div>
                            <div class="eme-form-group">
                                <label class="eme-checkbox-label">
                                    <input type="checkbox" required />
                                    <span>Autorizo o uso dos meus dados para fins de contato pela EME, conforme a LGPD.</span>
                                </label>
                            </div>
                    ...
                    <div class="eme-contato-info-box">
                        <div class="eme-info-card">
                            ...
                            <div class="eme-info-text">
                                <h4>E-mails Institucionais</h4>
                                <p>
                                    <a href="mailto:contato@escolaeme.com">contato@escolaeme.com</a><br>
                                    <a href="mailto:coordenacao@escolaeme.com">coordenacao@escolaeme.com</a><br>
                                    <a href="mailto:financeiro@escolaeme.com">financeiro@escolaeme.com</a><br>
                                    <a href="mailto:direcao@escolaeme.com">direcao@escolaeme.com</a>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="eme-info-card">
                            ...
                            <div class="eme-info-text">
                                ...
                                <p><a href="https://wa.me/5531984201358?text=Ol%C3%A1!%20Gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20a%20EME." target="_blank">(31) 98420-1358</a></p>
                            </div>
                        </div>
                        ...
                        <div class="eme-info-card">
                            ...
                            <div class="eme-info-text">
                                <h4>Endereço Sede</h4>
                                <p>Belo Horizonte — MG<br>(região Padre Eustáquio / Vila São Vicente)</p>
                            </div>
                        </div>
                        ...
                        <div class="eme-info-card">
                            <div class="eme-info-icon">🌐</div>
                            <div class="eme-info-text">
                                <h4>Portais Oficiais</h4>
                                <p>www.escolaeme.com<br>www.escolaeme.com.br</p>
                            </div>
                        </div>

                        <!-- Redes Sociais -->
                        <div class="eme-social-box">
                            <h4>Siga a EME nas Redes</h4>
                ...
                <div class="eme-map-section">
                    <h3 class="eme-section-title text-left" style="margin-top: 40px;">Localização da Escola</h3>
                    <div class="eme-divider divider-left"></div>
                    <div class="eme-map-responsive">
                        <iframe 
